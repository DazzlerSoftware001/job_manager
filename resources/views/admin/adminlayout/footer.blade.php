...
<script src="{{url('admin/assets/libs/metismenujs/metismenujs.min.js')}}"></script>
<script src="{{url('admin/assets/libs/simplebar/simplebar.min.js')}}"></script>
<script src="{{url('admin/assets/libs/eva-icons/eva.min.js')}}"></script>
...
<script src="{{url('admin/assets/libs/gridjs/gridjs.umd.js')}}"></script>

<script src="{{url('admin/assets/js/pages/gridjs.init.js')}}"></script>
