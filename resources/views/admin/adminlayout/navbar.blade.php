            ...
            <div class="navbar-header">
                ...
                @php
                    $breadcrumbs = [
                        ...
                        ['name' => 'Job List', 'route' => route('Admin.JobList')],
                            ...
                            <form class="p-3">
                                <div class="mb-2 position-relative">
                                    <input type="text" class="form-control form-control-sm rounded-pill ps-4"
                                        id="breadcrumb-search" placeholder="🔍 Search menu..."
                                ...
                                <div id="no-results" class="text-muted small text-center py-2 d-none">No matches found
                                </div>
                            </form>
                        </div>
