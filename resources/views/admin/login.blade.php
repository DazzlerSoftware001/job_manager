...
<body>
                ...
                <div class="col-xxl-8 col-lg-8 col-md-6">
                    <div class="auth-bg bg-white py-md-5 p-4 d-flex">
                        ...
                        <div class="row justify-content-center align-items-center">
                            <div class="col-xl-8">
                                <div class="mt-4">
                                    <img src="{{ url('admin/assets/images/login-img.png') }}" class="img-fluid"
                                        alt="">
                                </div>
    ...
    <script src="{{url('admin/assets/js/pages/pass-addon.init.js')}}"></script>

    <script src="{{url('admin/assets/js/pages/eva-icon.init.js')}}"></script>
    ...
    <script type="text/javascript">
        ...
        $('#Login').on('submit', function() {
            ...
            var url = "{{ route('Admin.loginInsert') }}";
