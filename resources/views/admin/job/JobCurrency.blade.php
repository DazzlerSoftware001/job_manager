...
@section('page-title')
    <div class="breadcrumb mt-2">
        {!! Breadcrumbs::render('Admin.JobCurrency') !!}
    </div>
...
@section('main-container')
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Job Currency</h4>
                            </div>
                            ...
                            <div class="px-3 mt-3 d-flex align-items-center gap-2">
                                ...
                                <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">+ Add Currency</button>
                            </div>
    ...
    <div class="modal fade" id="EditModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Currency</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <!-- form -->
                <form method="POST" action="javascript:void(0)" id="EditJobCurrency">
...
@section('script')
    ...
    <script>
        ...
        $('#myTable').DataTable({
            ...
            "order": [[0, "desc"]],
            "ajax": {
                url: "{{ route('Admin.GetJobCurrency') }}",
                type: 'POST',
                headers: {
    ...
    <script>
        $(document).ready(function() {
            $('#AddJobCurrency').on('submit', function(event) {
                event.preventDefault(); // Prevent default form submission
        
                var url = "{{ route('Admin.AddJobCurrency') }}";
                $.ajax({
                    url: url,
                    type: 'POST',
                    headers: {
            ...
            Swal.fire({
                ...
                if (response.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('Admin.DeleteJobCurrency') }}",
                        data: { id: id },
                        dataType: 'json',
    ...
    <script>
        ...
        $.ajax({
            ...
            url: "{{ route('Admin.EditJobCurrency') }}",
            data:{ id:id },
            dataType:'json',
            success:function(result)
            {   
            ...
            $('#editcurrency').val(record.currency);
    ...
    <script>
    $(document).ready(function() {
        $('#EditJobCurrency').on('submit', function(event) {
            event.preventDefault(); // Prevent default form submission
    
            var url = "{{ route('Admin.UpdateJobCurrency') }}";
            $.ajax({
                url: url,
                type: 'POST',
                headers: {
