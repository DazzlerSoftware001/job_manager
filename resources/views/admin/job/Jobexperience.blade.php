            ...
            <div class="modal-body">
                ...
                <form method="POST" action="javascript:void(0)" id="AddJobExperience">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="experience" id="experience" aria-describedby="countryHelp">
                    </div>
            </div>
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="javascript:void(0)" id="EditJobExp">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="editExp" id="editExp" aria-describedby="countryHelp">
                    </div>
