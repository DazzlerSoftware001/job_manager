                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="px-3 mt-3 d-flex align-items-center gap-2">
                                ...
                                <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">+ Add Job Role</button>
                            </div>
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="javascript:void(0)" id="AddJobRole">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="role" id="role" aria-describedby="countryHelp">
                    </div>
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="javascript:void(0)" id="EditJobRole">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="editrole" id="editrole" aria-describedby="countryHelp">
                    </div>
