...
@section('main-container')
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="px-3 mt-3 d-flex align-items-center gap-2">
                                ...
                                <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">+ Add Job Category</button>
                            </div>
    ...
    <div class="modal fade" id="EditModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel">Edit job category</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <!-- form -->
...
@section('script')
    ...
    <script>
        function changeStatus(id) {
            Swal.fire({
                title: 'Are you sure?',
                text: 'Do you want to change the status of this job category?',
                icon: 'warning',
                ...
                if (response.isConfirmed) {
                    ...
                    Swal.fire({
                        title: 'Cancelled',
                        text: 'The job category status was not changed.',
                        icon: 'info',
