...
@section('page-title')
    <div class="breadcrumb mt-2">
        {!! Breadcrumbs::render('Admin.JobTypes') !!}
    </div>
...
@section('main-container')
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <h1 class="modal-title fs-5" id="exampleModalLabel">Add job types</h1>
    ...
    <div class="modal fade" id="EditModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel">Edit job Types</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <!-- form -->
                <form method="POST" action="javascript:void(0)" id="EditJobTypes">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            $('#AddJobTypes').on('submit', function(event) {
                event.preventDefault(); // Prevent default form submission
        
                var url = "{{ route('Admin.AddJobTypes') }}";
                $.ajax({
                    url: url,
                    type: 'POST',
                    headers: {
     ...
     <script>
        function changeStatus(id) {
            Swal.fire({
                title: 'Are you sure?',
                text: 'Do you want to change the status of this job type?',
                icon: 'warning',
                ...
                if (response.isConfirmed) {
                    ...
                    $.ajax({
                        url: "{{ route('Admin.ChangeJobTypesStatus') }}",
                        type: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                    ...
                    Swal.fire({
                        title: 'Cancelled',
                        text: 'The job type status was not changed.',
                        icon: 'info',
            ...
            Swal.fire({
                ...
                if (response.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('Admin.DeleteJobTypes') }}",
                        data: { id: id },
                        dataType: 'json',
    ...
    <script>
    $(document).ready(function() {
        $('#EditJobTypes').on('submit', function(event) {
            event.preventDefault(); // Prevent default form submission
    
            var url = "{{ route('Admin.UpdateJobTypes') }}";
            $.ajax({
                url: url,
                type: 'POST',
                headers: {
