...
Route::prefix('install')->group(function () {
    Route::get('/', [InstallationController::class, 'preInstall'])->name('installer.pre-install');
    Route::get('/configuration', [InstallationController::class, 'configuration'])->name('installer.configuration');
    Route::post('/configuration', [InstallationController::class, 'storeConfiguration'])->name('installer.configuration.store');
    Route::get('/finish', [InstallationController::class, 'finish'])->name('installer.finish');
});
